...
function clean_journal_scripts() {
	 ...
	 */
	wp_enqueue_script( 'clean-journal-custom-scripts', get_template_directory_uri() . '/js/clean-journal-custom-scripts.min.js', array( 'jquery' ), null );

	// Load the html5 shiv.
	wp_enqueue_script( 'clean-journal-html5', get_template_directory_uri() . '/js/html5.min.js', array(), '3.7.3' );
